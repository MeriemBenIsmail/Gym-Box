  ...
  return (
      <div className={classes.navbar}>
          ...
          <ul className={classes.links}>
              ...
              <li>{activePage === "/blogs" || activePage === "/blogs/"+{id}.id ?  <Link className={classes.link} style={activeStyle} to='/blogs'>Blogs</Link> :  <Link className={classes.link} to='/blogs'>Blogs</Link>  }</li>
